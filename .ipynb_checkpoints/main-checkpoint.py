...
text_with_features_models = {
    "Isolation Forest with rates and helpful score": "all_results/Health_and_Personal_Care/Isolation Forest_with_numerical_data/Isolation Forest.joblib",
    "AutoEncoder with rates and helpful score": "all_results/Health_and_Personal_Care/AutoEncoder_with_numerical_data/AutoEncoder.joblib",
    "Variational AutoEncoder (VAE) with rates and helpful score": "all_results/Health_and_Personal_Care/Variational AutoEncoder (VAE)_with_numerical_data/Variational AutoEncoder (VAE).joblib"
}
models = {
